...
exec("from malscraper import version as version_number")
...
htmlhelp_basename = 'mal-scraper-doc'
...
latex_documents = [
    (master_doc, 'mal-scraper.tex', 'mal-scraper Documentation',
     'Hermann Krumrey', 'manual'),
]

# Man Pages
man_pages = [
    (master_doc, 'mal-scraper', 'mal-scraper Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mal-scraper', 'mal-scraper Documentation',
     author, 'mal-scraper', 'A web-scraping library for myanimelist.net',
     'Miscellaneous'),
]
